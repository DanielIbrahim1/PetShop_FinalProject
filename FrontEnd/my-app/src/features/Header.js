      ...
      >
        <div className="container">
          <Link
            ...
            to={{ pathname: "/" }}
          >
            <img src="http://127.0.0.1:8000/static/images/new-logo3.png"></img>
          </Link>
          {/* Home page */}
              ...
              {isStaff && (
                <li className="nav-item dropdown dropdown-slide">
                  ...
                  >
                    <li>
                      {" "}
                      <Link className="nav-link " to="/staffMenu/users">
                        {" "}
                        Users{" "}
                      </Link>
                    </li>
          ...
          >
            ...
            <li className="dropdown cart-nav dropdown-slide list-inline-item">
              <div>
                ...
                >
                  <i className="tf-ion-android-cart">
                    <a className="numberCircle">{myCart.length}</a>
                  </i>
                </a>
              </div>
              ...
              <div className="dropdown-menu cart-dropdown">
                ...
                <div className="cart-summary">
                  ...
                  <span className="total-price h6">{total_order_price} ₪</span>
            ...
            {logged && (
              <Link to="/" onClick={() => dispatch(logout())}>
                <img
                  className="media-object img-fluid mr-3"
                  src={`http://127.0.0.1:8000/static/images/check-out.png`}
                  alt="image"
                />
              </Link>
            )}
